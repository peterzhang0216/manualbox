...
#ifndef MANUALBOX_SWIFT_H
#define MANUALBOX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ManualBox",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class Product;
@class NSSet;
@interface Category (SWIFT_EXTENSION(ManualBox))
...
@class NSDate;
@interface Item (SWIFT_EXTENSION(ManualBox))
...
@class RepairRecord;
@interface Order (SWIFT_EXTENSION(ManualBox))
- (void)addRepairRecordsObject:(RepairRecord * _Nonnull)value;
- (void)removeRepairRecordsObject:(RepairRecord * _Nonnull)value;
- (void)addRepairRecords:(NSSet * _Nonnull)values;
- (void)removeRepairRecords:(NSSet * _Nonnull)values;
@end

@class NSDecimalNumber;
@interface Order (SWIFT_EXTENSION(ManualBox))
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic, copy) NSData * _Nullable invoiceData;
...
@property (nonatomic, copy) NSDate * _Nullable warrantyEndDate;
@property (nonatomic, strong) Product * _Nullable product;
@property (nonatomic, strong) NSSet * _Nullable repairRecords;
@end
...
@property (nonatomic, strong) NSSet * _Nullable manuals;
@property (nonatomic, strong) Order * _Nullable order;
@property (nonatomic, strong) NSSet * _Nullable tags;
@end

SWIFT_CLASS_NAMED("RepairRecord")
@interface RepairRecord : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface RepairRecord (SWIFT_EXTENSION(ManualBox))
@property (nonatomic, strong) NSDecimalNumber * _Nullable cost;
...
@interface Tag (SWIFT_EXTENSION(ManualBox))
- (void)addProductsObject:(Product * _Nonnull)value;
- (void)removeProductsObject:(Product * _Nonnull)value;
- (void)addProducts:(NSSet * _Nonnull)values;
- (void)removeProducts:(NSSet * _Nonnull)values;
